...
public class FileUtils {
	...
	public static final String ROOT_DIR = SystemUtils.getPackageName()
			.substring(SystemUtils.getPackageName().lastIndexOf(".") + 1);
...
//		sb.append(File.separator);
	...
	/** 获得指定路径的图片并转化为字符串 */
	public static String getFileSize2String(String strPath)
		...
		String imgstr = encoder.encode(data);// 返回Base64编码过的字节数组字符串
		return imgstr;
