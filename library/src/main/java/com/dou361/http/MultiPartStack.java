 ...
 * 创建日期：2015/11/11
 * <p/>
 * 描 述：这个Stack用于上传文件, 如果没有这个Stack, 则上传文件不成功
 * <p/>
 * <p/>
 * 修订历史：
 * <p/>
...
//                	postRequest.addHeader(HEADER_CONTENT_TYPE, request.getBodyContentType());
//                }
//                postRequest.addHeader(HEADER_CONTENT_TYPE, "multipart/form-data");
	...
	private static void setMultiPartBody(HttpEntityEnclosingRequestBase httpRequest,
		...
		for (Map.Entry<String, File> entry : fileUpload.entrySet()) {
			...
			builder.addBinaryBody(((String) entry.getKey()), entry.getValue());
        }
