...
public class StickEditText extends PopupWindow {
    ...
    public StickEditText(Activity context) {
        ...
        mMenuView = inflater.inflate(ResourceUtils.getResourceIdByName("layout", "popuwindow_edittext"), null);
        et_content = (EditText) mMenuView.findViewById(ResourceUtils.getResourceIdByName("id", "et_content"));
        btn_cancel = (Button) mMenuView.findViewById(ResourceUtils.getResourceIdByName("id", "btn_cancel"));
        // 取消按钮
        ...
        mMenuView.setOnTouchListener(new OnTouchListener() {
            ...
            public boolean onTouch(View v, MotionEvent event) {
                ...
                int height = mMenuView.findViewById(ResourceUtils.getResourceIdByName("id", "pop_layout")).getTop();
