...
import com.jingwang.eluxue_online.adapter.SectionedBaseAdapter;
...
public class PinnedHeaderListView extends ListView implements OnScrollListener {
	...
	public static interface PinnedSectionedHeaderAdapter {
		...
		public View getSectionFirstView(int section, View convertView,
										ViewGroup parent);
	...
	private View getSectionHeaderView(int section, View oldView) {
		...
		View view = mAdapter.getSectionFirstView(section, oldView, this);
		if (shouldLayout) {
