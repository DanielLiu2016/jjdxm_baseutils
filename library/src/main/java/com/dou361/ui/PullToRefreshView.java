...
public class PullToRefreshView extends LinearLayout {
    ...
    private void addHeaderView() {
        /** header view */
        mHeaderView = mInflater.inflate(ResourceUtils.getResourceIdByName("layout", "pfv_refresh_header"), this,
                false);

        mHeaderImageView = (ImageView) mHeaderView
                .findViewById(ResourceUtils.getResourceIdByName("id", "pull_to_refresh_image"));
        mHeaderTextView = (TextView) mHeaderView
                .findViewById(ResourceUtils.getResourceIdByName("id", "pull_to_refresh_text"));
        mHeaderUpdateTextView = (TextView) mHeaderView
                .findViewById(ResourceUtils.getResourceIdByName("id", "pull_to_refresh_updated_at"));
        mHeaderProgressBar = (ProgressBar) mHeaderView
                .findViewById(ResourceUtils.getResourceIdByName("id", "pull_to_refresh_progress"));
        /** header layout */
    ...
    private void addFooterView() {
        /** footer view */
        mFooterView = mInflater.inflate(ResourceUtils.getResourceIdByName("layout", "pfv_refresh_footer"), this,
                false);
        mFooterImageView = (ImageView) mFooterView
                .findViewById(ResourceUtils.getResourceIdByName("id", "pull_to_load_image"));
        mFooterTextView = (TextView) mFooterView
                .findViewById(ResourceUtils.getResourceIdByName("id", "pull_to_load_text"));
        mFooterUpdateTextView = (TextView) mFooterView
                .findViewById(ResourceUtils.getResourceIdByName("id", "pull_to_load_updated_at"));
        mFooterProgressBar = (ProgressBar) mFooterView
                .findViewById(ResourceUtils.getResourceIdByName("id", "pull_to_load_progress"));
        /** footer layout */
    ...
    private void headerPrepareToRefresh(int deltaY) {
        ...
        if (newTopMargin >= 0 && mHeaderState != RELEASE_TO_REFRESH) {
            ...
            mHeaderTextView.setText(ResourceUtils.getResourceIdByName("string", "pfv_pull_to_refresh_release_label"));
            ...
            mHeaderImageView.clearAnimation();
            mHeaderImageView.startAnimation(mReverseFlipAnimation);
            mHeaderTextView.setText(ResourceUtils.getResourceIdByName("string", "pfv_pull_to_refresh_pull_label"));
    ...
    private void footerPrepareToRefresh(int deltaY) {
        ...
        if (Math.abs(newTopMargin) >= (mHeaderViewHeight + mFooterViewHeight)
             ...
             */
            mFooterTextView
                    .setText(ResourceUtils.getResourceIdByName("string", "pfv_pull_to_refresh_footer_release_label"));
            ...
            mFooterImageView.startAnimation(mReverseFlipAnimation);
            mFooterTextView
                    .setText(ResourceUtils.getResourceIdByName("string", "pfv_pull_to_refresh_footer_pull_label"));
    ...
    public void headerRefreshing() {
        ...
        mHeaderTextView.setText(ResourceUtils.getResourceIdByName("string", "pfv_pull_to_refresh_refreshing_label"));
    ...
    private void footerRefreshing() {
        ...
        mFooterTextView
                .setText(ResourceUtils.getResourceIdByName("string", "pfv_pull_to_refresh_footer_refreshing_label"));
    ...
    public void onHeaderRefreshComplete() {
        ...
        mHeaderImageView.setImageResource(ResourceUtils.getResourceIdByName("mipmap", "ic_pulltorefresh_arrow"));
        mHeaderTextView.setText(ResourceUtils.getResourceIdByName("string", "pfv_pull_to_refresh_pull_label"));
    ...
    public void onFooterRefreshComplete() {
        ...
        mFooterImageView.setImageResource(ResourceUtils.getResourceIdByName("mipmap", "ic_pulltorefresh_arrow_up"));
        mFooterTextView.setText(ResourceUtils.getResourceIdByName("string", "pfv_pull_to_refresh_footer_pull_label"));
